...
const CreateCompanySuccessfull = () => {
	...
	return (
		<Layout>
			...
			<SuccessfullCard
				heading='Company added successfully!'
			...
			>
				<span className='text-sm text-neutral-900 leading-5 text-center'>
					We are excited to announce that "ABC Tech" has been successfully added
					to our system! To get started with adding your team members, please
...
export default CreateCompanySuccessfull;
